...
public class ViewInterventoActivity extends ActionBarActivity {
	...
	protected void onStart() {
		...
		try {
			...
			if (idIntervento > 0L) {
				...
				InterventoController.controller = com.federicocolantoni.projects.interventix.controller.InterventoSingleton_.getInstance_(this);
	...
	private static void saveInterventoOnDB() {
		...
		if (InterventoController.controller.getIntervento().getIdIntervento() > 0)
