...
public class GetUtenteAsyncTack extends AsyncTask<Long, Void, Utente> {
	...
	protected Utente doInBackground(Long... params) {
		...
		String[] projection = new String[] { UtenteDB.Fields._ID, UtenteDB.Fields.CANCELLATO, UtenteDB.Fields.CESTINATO, UtenteDB.Fields.COGNOME, UtenteDB.Fields.CONFLITTO,
