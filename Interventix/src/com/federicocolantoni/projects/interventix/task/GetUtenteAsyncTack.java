...
public class GetUtenteAsyncTack extends AsyncTask<Long, Void, Utente> {
	...
	String[] projection =
		new String[] {
			Fields._ID, UtenteDB.Fields.CANCELLATO, UtenteDB.Fields.CESTINATO, UtenteDB.Fields.COGNOME, UtenteDB.Fields.CONFLITTO, UtenteDB.Fields.EMAIL, UtenteDB.Fields.ID_UTENTE,
			UtenteDB.Fields.NOME, UtenteDB.Fields.REVISIONE, UtenteDB.Fields.TIPO, UtenteDB.Fields.USERNAME
		};
