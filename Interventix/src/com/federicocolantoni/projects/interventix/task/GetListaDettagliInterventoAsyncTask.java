...
public class GetListaDettagliInterventoAsyncTask extends AsyncTask<Long, Void, ListDetailsIntervento> {
	...
	String[] projection =
		new String[] {
			Fields._ID, DettaglioInterventoDB.Fields.ID_DETTAGLIO_INTERVENTO, DettaglioInterventoDB.Fields.INTERVENTO, DettaglioInterventoDB.Fields.DESCRIZIONE,
			DettaglioInterventoDB.Fields.OGGETTO, DettaglioInterventoDB.Fields.TIPO, DettaglioInterventoDB.Fields.INIZIO, DettaglioInterventoDB.Fields.FINE,
			DettaglioInterventoDB.Fields.MODIFICATO, DettaglioInterventoDB.Fields.NUOVO, DettaglioInterventoDB.Fields.TECNICI
		};
	...
	while (cursor.moveToNext()) {
	    ...
	    detailInterv.nuovo =
		    ((cursor.getString(cursor.getColumnIndex(DettaglioInterventoDB.Fields.NUOVO)) != null && cursor.getString(cursor.getColumnIndex(DettaglioInterventoDB.Fields.NUOVO)).equals(
			    Constants.DETTAGLIO_NUOVO)) ? true : false);
