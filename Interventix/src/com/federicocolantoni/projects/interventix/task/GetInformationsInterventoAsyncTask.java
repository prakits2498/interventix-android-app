...
public class GetInformationsInterventoAsyncTask extends AsyncTask<Long, Void, Intervento> {
	...
	Fields._ID, InterventoDB.Fields.TIPOLOGIA, InterventoDB.Fields.MODALITA, InterventoDB.Fields.PRODOTTO, InterventoDB.Fields.MOTIVO, InterventoDB.Fields.NOMINATIVO, InterventoDB.Fields.DATA_ORA
	};
