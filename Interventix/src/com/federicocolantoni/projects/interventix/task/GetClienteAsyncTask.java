...
public class GetClienteAsyncTask extends AsyncTask<Long, Void, Cliente> {
	...
	protected Cliente doInBackground(Long... params) {
		...
		String[] projection = new String[] { Fields._ID, ClienteDB.Fields.CANCELLATO, ClienteDB.Fields.CITTA, ClienteDB.Fields.CODICE_FISCALE, ClienteDB.Fields.CONFLITTO,
				ClienteDB.Fields.EMAIL, ClienteDB.Fields.FAX, ClienteDB.Fields.ID_CLIENTE, ClienteDB.Fields.INDIRIZZO, ClienteDB.Fields.INTERNO, ClienteDB.Fields.MODIFICATO,
