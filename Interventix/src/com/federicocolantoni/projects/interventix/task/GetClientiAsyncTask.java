...
public class GetClientiAsyncTask extends AsyncTask<Void, Void, ArrayList<Cliente>> {
	...
	protected ArrayList<Cliente> doInBackground(Void... params) {
		...
		String[] PROJECTION = new String[] { Fields._ID, ClienteDB.Fields.CANCELLATO, ClienteDB.Fields.CITTA, ClienteDB.Fields.CODICE_FISCALE, ClienteDB.Fields.CONFLITTO,
				ClienteDB.Fields.EMAIL, ClienteDB.Fields.FAX, ClienteDB.Fields.ID_CLIENTE, ClienteDB.Fields.INDIRIZZO, ClienteDB.Fields.INTERNO, ClienteDB.Fields.NOMINATIVO,
