...
public class DettaglioIntervento implements Serializable {
	...
	private String tipo, oggetto, descrizione;
	...
	public String toString() {
		...
		return String.format("DettaglioIntervento [idDettaglioIntervento=%s, tipo=%s, oggetto=%s, descrizione=%s, intervento=%s, inizio=%s, fine=%s, tecnici=%s]",
				iddettagliointervento, tipo, oggetto, descrizione, idintervento, inizio, fine, tecniciintervento);
	}
