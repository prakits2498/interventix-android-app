...
public class Intervento implements Serializable {
	...
	private String tipologia, prodotto, motivo, nominativo, riffattura, rifscontrino, note, modalita;
	...
	public String toString() {
		...
		return String
				.format("Intervento [idintervento=%s, tipologia=%s, prodotto=%s, motivo=%s, nominativo=%s, riffattura=%s, rifscontrino=%s, note=%s, modalita=%s, firma=%s, saldato=%s, cancellato=%s, chiuso=%s, conflitto=%s, dataora=%s, cliente=%s, tecnico=%s, costomanodopera=%s, costocomponenti=%s, costoaccessori=%s, importo=%s, totale=%s, iva=%s, numero=%s]",
						idintervento, tipologia, prodotto, motivo, nominativo, riffattura, rifscontrino, note, modalita, firma.substring(0, 29).concat("..."), saldato, cancellato,
