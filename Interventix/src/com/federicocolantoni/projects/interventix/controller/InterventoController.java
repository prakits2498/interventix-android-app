...
public class InterventoController {
	...
	public static void updateOnDB() {
		...
		String[] selectionArgsTecnico = new String[] { UtenteDB.UTENTE_ITEM_TYPE, "" + controller.getTecnico().getIdUtente() };
		...
		String[] selectionArgsCliente = new String[] { ClienteDB.CLIENTE_ITEM_TYPE, "" + controller.getCliente().getIdCliente() };
		...
		String[] selectionArgsIntervento = new String[] { InterventoDB.INTERVENTO_ITEM_TYPE, "" + controller.getIntervento().getIdIntervento() };
	...
	public static void putDettaglioOnDB(AsyncQueryHandler queryHandler) {
		...
		for (DettaglioIntervento dettaglio : controller.getListaDettagli()) {
			...
			if (dettaglio.isNuovo() && dettaglio.getModificato().equals(Constants.DETTAGLIO_NUOVO)) {

				ContentValues valuesDettaglio = DettaglioIntervento.insertSQL(dettaglio, false, dettaglio.isNuovo());
				...
				String[] selectionArgsDettaglio = new String[] { DettaglioInterventoDB.DETTAGLIO_INTERVENTO_ITEM_TYPE, "" + dettaglio.getIdDettaglioIntervento() };
