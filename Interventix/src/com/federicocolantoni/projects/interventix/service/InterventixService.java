...
public class InterventixService extends IntentService {
	...
	private void inviaClienti() {
		...
		String[] projection = new String[] { Fields._ID, ClienteDB.Fields.ID_CLIENTE, ClienteDB.Fields.CANCELLATO, ClienteDB.Fields.CITTA, ClienteDB.Fields.CODICE_FISCALE,
				ClienteDB.Fields.CONFLITTO, ClienteDB.Fields.EMAIL, ClienteDB.Fields.FAX, ClienteDB.Fields.INDIRIZZO, ClienteDB.Fields.INTERNO, ClienteDB.Fields.NOMINATIVO,
				ClienteDB.Fields.NOTE, ClienteDB.Fields.PARTITAIVA, ClienteDB.Fields.REFERENTE, ClienteDB.Fields.REVISIONE, ClienteDB.Fields.TELEFONO, ClienteDB.Fields.UFFICIO };
	...
	private void inviaInterventi() {
		...
		String[] projection = new String[] { Fields._ID, InterventoDB.Fields.CANCELLATO, InterventoDB.Fields.CHIUSO, InterventoDB.Fields.CLIENTE, InterventoDB.Fields.CONFLITTO,
				...
				InterventoDB.Fields.PRODOTTO, InterventoDB.Fields.RIFERIMENTO_FATTURA, InterventoDB.Fields.RIFERIMENTO_SCONTRINO, InterventoDB.Fields.SALDATO,
				InterventoDB.Fields.TECNICO, InterventoDB.Fields.TIPOLOGIA, InterventoDB.Fields.TOTALE };

		String selection = Fields.TYPE + "=? AND " + InterventoDB.Fields.MODIFICATO + " IN(?,?)";

		String[] selectionArgs = new String[] { InterventoDB.INTERVENTO_ITEM_TYPE, Constants.INTERVENTO_MODIFICATO, Constants.INTERVENTO_NUOVO };
