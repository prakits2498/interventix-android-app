...
public class InterventixService extends IntentService {
	...
	private void inviaClienti() {
		...
		String[] projection = new String[] { ClienteDB.Fields._ID, ClienteDB.Fields.ID_CLIENTE, ClienteDB.Fields.CANCELLATO, ClienteDB.Fields.CITTA,
				ClienteDB.Fields.CODICE_FISCALE, ClienteDB.Fields.CONFLITTO, ClienteDB.Fields.EMAIL, ClienteDB.Fields.FAX, ClienteDB.Fields.INDIRIZZO, ClienteDB.Fields.INTERNO,
	...
	private void inviaInterventi() {
		...
		String[] projection = new String[] { InterventoDB.Fields._ID, InterventoDB.Fields.CANCELLATO, InterventoDB.Fields.CHIUSO, InterventoDB.Fields.CLIENTE,
				InterventoDB.Fields.CONFLITTO, InterventoDB.Fields.COSTO_ACCESSORI, InterventoDB.Fields.COSTO_COMPONENTI, InterventoDB.Fields.COSTO_MANODOPERA,
				InterventoDB.Fields.DATA_ORA, InterventoDB.Fields.FIRMA, InterventoDB.Fields.ID_INTERVENTO, InterventoDB.Fields.IMPORTO, InterventoDB.Fields.IVA,
				InterventoDB.Fields.MODALITA, InterventoDB.Fields.MODIFICATO, InterventoDB.Fields.MOTIVO, InterventoDB.Fields.NOMINATIVO, InterventoDB.Fields.NOTE,
				InterventoDB.Fields.NUMERO_INTERVENTO, InterventoDB.Fields.PRODOTTO, InterventoDB.Fields.RIFERIMENTO_FATTURA, InterventoDB.Fields.RIFERIMENTO_SCONTRINO,
		...
		String[] selectionArgs = new String[] { InterventoDB.INTERVENTO_ITEM_TYPE, "M", "0" };
