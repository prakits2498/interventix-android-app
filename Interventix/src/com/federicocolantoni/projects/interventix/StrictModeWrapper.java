...
public class StrictModeWrapper {
	...
	if (BuildConfig.DEBUG) {
		...
		StrictMode.setVmPolicy(new StrictMode.VmPolicy.Builder().detectLeakedSqlLiteObjects().detectActivityLeaks().detectLeakedClosableObjects().penaltyLog().penaltyDeath().build());
