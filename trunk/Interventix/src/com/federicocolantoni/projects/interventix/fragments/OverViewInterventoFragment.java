...
public class OverViewInterventoFragment extends Fragment {
	...
	((ActionBarActivity) getActivity()).getSupportActionBar().setSubtitle("Intervento " + Constants.sIdInterventoTemp);
	...
	if (InterventoController.controller.getIntervento().getTotale() != null)
	    tv_row_costs.setText(formatter.format(InterventoController.controller.getIntervento().getTotale().doubleValue()) + " €");
	
	if (InterventoController.controller.getIntervento().getFirma() != null)
