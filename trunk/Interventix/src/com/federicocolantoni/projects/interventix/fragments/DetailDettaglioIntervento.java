...
import com.federicocolantoni.projects.interventix.utils.GetDettaglioIntervento;
import com.federicocolantoni.projects.interventix.utils.InterventixToast;
import com.federicocolantoni.projects.interventix.utils.SaveChangesDettaglioIntervento;

@SuppressLint("NewApi")
public class DetailDettaglioIntervento extends SherlockFragment {
	...
	final View view = inflater.inflate(
		R.layout.detail_dett_intervento_fragment, container, false);

	Bundle bundle = getArguments();

	sId_Dettaglio_Intervento = bundle
		.getLong(Constants.ID_DETTAGLIO_INTERVENTO);

	DettaglioIntervento dettInterv = null;

	try {
	    dettInterv = new GetDettaglioIntervento(getSherlockActivity())
		    .execute(sId_Dettaglio_Intervento).get();
	...
	TextView tv_dett_interv = (TextView) view
		.findViewById(R.id.tv_dett_interv);
	...
	row_tipo_dett.setOnClickListener(new OnClickListener() {
		...
		new SetTipo().show(getFragmentManager(),
			Constants.TIPO_DETTAGLIO_DIALOG_FRAGMENT);
	    }
	});

	TextView tv_row_tipo_dett = (TextView) row_tipo_dett
		.findViewById(R.id.tv_row_tipo_dettaglio);
	...
	row_oggetto_dett.setOnClickListener(new OnClickListener() {
		...
		new SetOggetto().show(getFragmentManager(),
			Constants.OGGETTO_DETTAGLIO_DIALOG_FRAGMENT);
	    }
	});

	TextView tv_row_oggetto_dett = (TextView) row_oggetto_dett
		.findViewById(R.id.tv_row_oggetto_dettaglio);
	tv_row_oggetto_dett.setText(dettInterv.getmOggetto());

	View row_tecnici_dett = view.findViewById(R.id.row_tecnici_dettaglio);

	TextView tv_row_tecnici_dett = (TextView) row_tecnici_dett
		.findViewById(R.id.tv_row_tecnici_dettaglio);
	tv_row_tecnici_dett.setText("" + dettInterv.getmTecnici().size());

	View row_descrizione_dett = view
		.findViewById(R.id.row_descrizione_dettaglio);
	...
	row_descrizione_dett.setOnClickListener(new OnClickListener() {
		...
		new SetDecrizione().show(getFragmentManager(),
			Constants.DESCRIZIONE_DETTAGLIO_DIALOG_FRAGMENT);
	    }
	});

	TextView tv_row_descrizione_dett = (TextView) row_descrizione_dett
		.findViewById(R.id.tv_row_descrizione_dettaglio);
	tv_row_descrizione_dett.setText(dettInterv.getmDescrizione());

	final View row_inizio_dett = view
		.findViewById(R.id.row_inizio_dettaglio);
	...
	row_inizio_dett.setOnClickListener(new OnClickListener() {
		...
		final TextView tv_row_inizio_dett = (TextView) row_inizio_dett
			.findViewById(R.id.tv_row_inizio_dettaglio);
		...
		dt = DateTime.parse(tv_row_inizio_dett.getText().toString(),
		...
		((Button) dateTimeDialogView.findViewById(R.id.SetDateTime))
			.setOnClickListener(new OnClickListener() {
				...
				TextView tv_dett_ore_tot = (TextView) getSherlockActivity()
					.findViewById(
						R.id.tv_row_tot_ore_dettaglio);
				TextView tv_dett_fine = (TextView) getSherlockActivity()
					.findViewById(
						R.id.tv_row_fine_dettaglio);
				...
				dt_fine = fmt.parseDateTime(tv_dett_fine
					.getText().toString());

				if (dt_fine.toDate().getTime() < dt_inizio
					.toDate().getTime()) {
				    InterventixToast
					    .makeToast(
						    getSherlockActivity(),
						    "Errore! Inizio intervento maggiore di fine intervento",
						    Toast.LENGTH_LONG);
				} else {

				    tv_row_inizio_dett.setText(dt_inizio
					    .toString("dd/MM/yyyy HH:mm"));

				    DateTime dt_tot_ore = new DateTime(dt_fine
					    .toDate().getTime()
					    - dt_inizio.toDate().getTime(),
					    DateTimeZone.forID("Europe/Rome"));

				    tv_dett_ore_tot.setText(dt_tot_ore
					    .toString("HH:mm"));

				    SaveChangesDettaglioIntervento saveChanges = new SaveChangesDettaglioIntervento(
					    getSherlockActivity());
				    ...
				    String selection = DettaglioInterventoDB.Fields.TYPE
					    + " = ? AND "
				    ...
				    saveChanges.startUpdate(TOKEN_ORA_INIZIO,
					    null,
					    DettaglioInterventoDB.CONTENT_URI,
				    ...
				    edit.putBoolean(
					    Constants.DETT_INTERV_MODIFIED,
					    true);
		...
		((Button) dateTimeDialogView.findViewById(R.id.ResetDateTime))
			.setOnClickListener(new View.OnClickListener() {
				...
				dt = fmt.parseDateTime(tv_row_inizio_dett
					.getText().toString());
	...
	TextView tv_row_inizio_dett = (TextView) row_inizio_dett
		.findViewById(R.id.tv_row_inizio_dettaglio);

	DateTime dt_inizio = new DateTime(dettInterv.getmInizio(),
		DateTimeZone.forID("Europe/Rome"));
	...
	row_fine_dett.setOnClickListener(new OnClickListener() {
		...
		final TextView tv_row_fine_dett = (TextView) row_fine_dett
			.findViewById(R.id.tv_row_fine_dettaglio);
		...
		dt = DateTime.parse(tv_row_fine_dett.getText().toString(),
			DateTimeFormat.forPattern("dd/MM/yyyy HH:mm"));
		...
		((Button) dateTimeDialogView.findViewById(R.id.SetDateTime))
			.setOnClickListener(new OnClickListener() {
				...
				DateTime dt_fine = new DateTime(dateTimePicker
				...
				TextView tv_dett_ore_tot = (TextView) getSherlockActivity()
					.findViewById(
						R.id.tv_row_tot_ore_dettaglio);
				TextView tv_dett_inizio = (TextView) getSherlockActivity()
					.findViewById(
						R.id.tv_row_inizio_dettaglio);
				...
				dt_inizio = fmt.parseDateTime(tv_dett_inizio
					.getText().toString());
				...
				if (dt_fine.toDate().getTime() < dt_inizio
				    ...
				    tv_row_fine_dett.setText(dt_fine
					    .toString("dd/MM/yyyy HH:mm"));
				    ...
				    saveChanges.startUpdate(TOKEN_ORA_FINE,
					    null,
					    DettaglioInterventoDB.CONTENT_URI,
					    values, selection, selectionArgs);
		...
		((Button) dateTimeDialogView.findViewById(R.id.ResetDateTime))
			.setOnClickListener(new View.OnClickListener() {
				...
				dt = fmt.parseDateTime(tv_row_fine_dett
					.getText().toString());
	...
	TextView tv_row_fine_dett = (TextView) row_fine_dett
		.findViewById(R.id.tv_row_fine_dettaglio);

	DateTime dt_fine = new DateTime(dettInterv.getmFine(),
		DateTimeZone.forID("Europe/Rome"));
	...
	TextView tv_row_tot_ore_dett = (TextView) row_tot_ore_dett
		.findViewById(R.id.tv_row_tot_ore_dettaglio);

	DateTime dt_tot_ore = new DateTime(dt_fine.toDate().getTime()
		- dt_inizio.toDate().getTime(),
		DateTimeZone.forID("Europe/Rome"));

	tv_row_tot_ore_dett.setText(dt_tot_ore.toString(DateTimeFormat
		.forPattern("HH:mm")));

	return view;
    }

    public static class SetTipo extends SherlockDialogFragment implements
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
	    ...
	    TextView tv_tipo_dett = (TextView) getSherlockActivity()
		    .findViewById(R.id.tv_row_tipo_dettaglio);
	...
	public void onClick(DialogInterface dialog, int which) {
	    ...
	    ContentValues values = new ContentValues();
	    values.put(DettaglioInterventoDB.Fields.TIPO, mEdit_tipo_dett
		    .getText().toString());
    ...
    public static class SetOggetto extends SherlockDialogFragment implements
	    DialogInterface.OnClickListener {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
	    ...
	    AlertDialog.Builder oggetto_dett = new Builder(
		    getSherlockActivity());

	    oggetto_dett.setTitle(R.string.oggetto_dett_title);

	    TextView tv_oggetto_dett = (TextView) getSherlockActivity()
		    .findViewById(R.id.tv_row_oggetto_dettaglio);
	    ...
	    oggetto_dett.setPositiveButton(
		    getResources().getString(R.string.ok_btn), this);
	...
	public void onClick(DialogInterface dialog, int which) {
	    ...
	    ContentValues values = new ContentValues();
	    values.put(DettaglioInterventoDB.Fields.OGGETTO, mEdit_oggetto_dett
		    .getText().toString());
	    values.put(DettaglioInterventoDB.Fields.MODIFICATO, "M");
    ...
    public static class SetDecrizione extends SherlockDialogFragment implements
	    DialogInterface.OnClickListener {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
	    ...
	    AlertDialog.Builder decrizione_dett = new Builder(
		    getSherlockActivity());

	    decrizione_dett.setTitle(R.string.oggetto_dett_title);

	    TextView tv_descrizione_dett = (TextView) getSherlockActivity()
		    .findViewById(R.id.tv_row_descrizione_dettaglio);
	    ...
	    decrizione_dett.setPositiveButton(
		    getResources().getString(R.string.ok_btn), this);
	...
	public void onClick(DialogInterface dialog, int which) {
	    ...
	    ContentValues values = new ContentValues();
	    values.put(DettaglioInterventoDB.Fields.DESCRIZIONE,
		    mEdit_descrizione_dett.getText().toString());
	    values.put(DettaglioInterventoDB.Fields.MODIFICATO, "M");
