...
public class CostsInterventoFragment extends Fragment {
	...
	mEditManodopera.setText("" + (InterventoController.controller.getIntervento().getCostoManodopera() != null ? InterventoController.controller.getIntervento().getCostoManodopera() : 0.0));
	...
	costoAccessoriDialog.setPositiveButton(R.string.ok_btn, new DialogInterface.OnClickListener() {
		...
		InterventoController.controller.getIntervento().setImporto(new BigDecimal(InterventoController.controller.getIntervento().getCostoManodopera().doubleValue() + (InterventoController.controller.getIntervento().getCostoAccessori() != null ? InterventoController.controller.getIntervento().getCostoAccessori().doubleValue() : 0.0) + (InterventoController.controller.getIntervento().getCostoComponenti() != null ? InterventoController.controller.getIntervento().getCostoComponenti().doubleValue() : 0.0)));
		...
		InterventoController.controller.getIntervento().setTotale(new BigDecimal(InterventoController.controller.getIntervento().getImporto().doubleValue() + InterventoController.controller.getIntervento().getIva().doubleValue()));
	...
	mEditComponenti.setText("" + (InterventoController.controller.getIntervento().getCostoComponenti() != null ? InterventoController.controller.getIntervento().getCostoComponenti() : 0.0));
	...
	costoAccessoriDialog.setPositiveButton(R.string.ok_btn, new DialogInterface.OnClickListener() {
		...
		InterventoController.controller.getIntervento().setImporto(new BigDecimal(InterventoController.controller.getIntervento().getCostoComponenti().doubleValue() + (InterventoController.controller.getIntervento().getCostoAccessori() != null ? InterventoController.controller.getIntervento().getCostoAccessori().doubleValue() : 0.0) + (InterventoController.controller.getIntervento().getCostoManodopera() != null ? InterventoController.controller.getIntervento().getCostoManodopera().doubleValue() : 0.0)));
		InterventoController.controller.getIntervento().setIva(new BigDecimal(InterventoController.controller.getIntervento().getImporto().doubleValue() * Constants.IVA));
		InterventoController.controller.getIntervento().setTotale(new BigDecimal(InterventoController.controller.getIntervento().getImporto().doubleValue() + InterventoController.controller.getIntervento().getIva().doubleValue()));
	...
	mEditAccessori.setText("" + (InterventoController.controller.getIntervento().getCostoAccessori() != null ? InterventoController.controller.getIntervento().getCostoAccessori() : 0.0));
	...
	costoAccessoriDialog.setPositiveButton(R.string.ok_btn, new DialogInterface.OnClickListener() {
		...
		InterventoController.controller.getIntervento().setImporto(new BigDecimal(InterventoController.controller.getIntervento().getCostoAccessori().doubleValue() + (InterventoController.controller.getIntervento().getCostoManodopera() != null ? InterventoController.controller.getIntervento().getCostoManodopera().doubleValue() : 0.0) + (InterventoController.controller.getIntervento().getCostoComponenti() != null ? InterventoController.controller.getIntervento().getCostoComponenti().doubleValue() : 0.0)));
		InterventoController.controller.getIntervento().setIva(new BigDecimal(InterventoController.controller.getIntervento().getImporto().doubleValue() * Constants.IVA));
		InterventoController.controller.getIntervento().setTotale(new BigDecimal(InterventoController.controller.getIntervento().getImporto().doubleValue() + InterventoController.controller.getIntervento().getIva().doubleValue()));
