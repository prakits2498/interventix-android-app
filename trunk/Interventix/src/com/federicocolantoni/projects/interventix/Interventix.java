...
@ReportsCrashes(formKey = "", formUri = "http://10.0.2.2:3000/logs/Interventix" /*"https://10.0.2.2:5984/acra-interventix/_design/acra-storage/_update/report"*/, reportType = org.acra.sender.HttpSender.Type.JSON, httpMethod = org.acra.sender.HttpSender.Method.PUT, /*formUriBasicAuthLogin = "devilman", formUriBasicAuthPassword = "pippo100", mailTo = "chicco.colantoni@gmail.com",*/customReportContent = {
	...
	THREAD_DETAILS, TOTAL_MEM_SIZE, LOGCAT }, mode = ReportingInteractionMode.TOAST, forceCloseDialogAfterToast = false, resToastText = R.string.crash_toast_report)
