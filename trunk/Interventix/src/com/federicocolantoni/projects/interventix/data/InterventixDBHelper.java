...
public class InterventixDBHelper extends SQLiteOpenHelper {
    ...
    private static String CREATE_TABLE_INTERVENTIX = "CREATE TABLE IF NOT EXISTS "
    ...
    private final static String[] CREATE_INDEXES = {
	    "CREATE INDEX " + InterventixDBContract.Data.Fields.INDEX + " ON "
		    + InterventixDBContract.Data.DB_TABLE + "("
		    + InterventixDBContract.Data.Fields.INDEX + ")",
	    "CREATE INDEX " + InterventixDBContract.Data.Fields.TYPE + " ON "
		    + InterventixDBContract.Data.DB_TABLE + "("
