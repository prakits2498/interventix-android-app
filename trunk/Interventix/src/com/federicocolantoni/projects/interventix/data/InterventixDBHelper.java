...
public class InterventixDBHelper extends SQLiteOpenHelper {
	...
	private static String CREATE_TABLE_INTERVENTIX = "CREATE TABLE IF NOT EXISTS " + InterventixDBContract.Data.DB_TABLE + "(" + InterventixDBContract.Data.Fields._ID
			+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + InterventixDBContract.Data.Fields.TYPE + " INTEGER NOT NULL, ";
	...
	private final static String[] DROP_INDEXES = { "DROP INDEX " + InterventixDBContract.Data.Fields.INDEX, "DROP INDEX " + InterventixDBContract.Data.Fields.TYPE };
