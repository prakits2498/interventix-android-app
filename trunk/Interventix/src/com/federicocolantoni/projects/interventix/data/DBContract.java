...
public class DBContract {
	...
	public static class Fields extends Data.Fields {
	    ...
	    public static final String ORA_INIZIO = DATA[10];
	    public static final String ORA_FINE = DATA[11];
	    public static final String CLIENTE = DATA[12];
	    public static final String TECNICO = DATA[13];
	    public static final String COSTO_MANODOPERA = DATA[14];
	    public static final String COSTO_COMPONENTI = DATA[15];
	    public static final String COSTO_ACCESSORI = DATA[16];
	    public static final String IMPORTO = DATA[17];
	...
	public static class Fields extends Data.Fields {
	    ...
	    public static final String TIPO = DATA[0];
