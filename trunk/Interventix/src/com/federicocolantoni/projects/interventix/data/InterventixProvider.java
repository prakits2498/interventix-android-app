 ...
 */
public class InterventixProvider
    ...
    static {
        MATCHER.addURI(DBContract.AUTHORITY, DBContract.Data.PATH, COLLECTION);
        MATCHER.addURI(DBContract.AUTHORITY, DBContract.Data.PATH + "/#", SINGLE_ITEM);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if (match == SINGLE_ITEM) { where = Fields._ID + " = " + uri.getLastPathSegment(); }
        else if (match != COLLECTION) { throw new UnsupportedOperationException("URI " + uri + " not supported!"); }

        SQLiteQueryBuilder queryBuilder = new SQLiteQueryBuilder();
        queryBuilder.setTables(Data.DB_TABLE);
        if (where != null) { queryBuilder.appendWhere(where); }
    ...
    public String getType(Uri uri) {
        switch (MATCHER.match(uri)) {
            case SINGLE_ITEM:
                return DBContract.Data.SINGLE_ITEM_TYPE;
            case COLLECTION:
                return DBContract.Data.COLLECTION_TYPE;
            default:
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if (match == SINGLE_ITEM) {
            selection = Fields._ID + " = " + uri.getLastPathSegment()
