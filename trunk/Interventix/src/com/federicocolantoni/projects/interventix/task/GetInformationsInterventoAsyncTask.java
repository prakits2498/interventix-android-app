...
public class GetInformationsInterventoAsyncTask extends AsyncTask<Long, Void, Intervento> {
	...
	protected Intervento doInBackground(Long... params) {
		...
		String[] projection = new String[] { Fields._ID, InterventoDB.Fields.TIPOLOGIA, InterventoDB.Fields.MODALITA, InterventoDB.Fields.PRODOTTO, InterventoDB.Fields.MOTIVO,
