...
public class GetClienteAsyncTask extends AsyncTask<Long, Void, Cliente> {
	...
	protected Cliente doInBackground(Long... params) {
		...
		String[] projection = new String[] { ClienteDB.Fields._ID, ClienteDB.Fields.CANCELLATO, ClienteDB.Fields.CITTA, ClienteDB.Fields.CODICE_FISCALE,
				...
				ClienteDB.Fields.MODIFICATO, ClienteDB.Fields.NOMINATIVO, ClienteDB.Fields.NOTE, ClienteDB.Fields.PARTITAIVA, ClienteDB.Fields.REFERENTE,
				ClienteDB.Fields.REVISIONE, ClienteDB.Fields.TELEFONO, ClienteDB.Fields.UFFICIO };
