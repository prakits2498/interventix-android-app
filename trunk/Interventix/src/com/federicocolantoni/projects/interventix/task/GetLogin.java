...
public class GetLogin extends AsyncTask<String, Void, Integer> {
	...
	if (result == Activity.RESULT_OK) {
	    ...
	    if (result == Constants.ERRORE_LOGIN)
		InterventixToast.makeToast(context.getString(R.string.toast_login_error), Toast.LENGTH_LONG);
	    else
		if (result == Constants.ERRORE_NO_CONNECTION) {
		    InterventixToast.makeToast(context.getString(R.string.toast_offline_access), Toast.LENGTH_LONG);
		}
    }
}
