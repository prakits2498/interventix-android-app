...
public class GetListaDettagliInterventoAsyncTask extends AsyncTask<Long, Void, ListDetailsIntervento> {
	...
	protected ListDetailsIntervento doInBackground(Long... params) {
		...
		String[] projection = new String[] { DettaglioInterventoDB.Fields._ID, DettaglioInterventoDB.Fields.ID_DETTAGLIO_INTERVENTO, DettaglioInterventoDB.Fields.INTERVENTO,
				...
				DettaglioInterventoDB.Fields.FINE, DettaglioInterventoDB.Fields.MODIFICATO, DettaglioInterventoDB.Fields.TECNICI };
