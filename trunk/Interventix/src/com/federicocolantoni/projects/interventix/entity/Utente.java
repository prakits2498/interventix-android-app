...
public class Utente implements Serializable {
	...
	return String.format("Utente [idutente=%s, revisione=%s, nome=%s, cognome=%s, username=%s, password=%s, email=%s, tipo=%s, cancellato=%s, cestinato=%s, conflitto=%s]", idutente, revisione, nome, cognome, username, password, email, tipo, cancellato, cestinato, conflitto);
    }
	...
	if (idutente == null) {
	    ...
	    if (!idutente.equals(other.idutente)) {
		return false;
	    }
	if (nome == null) {
	    if (other.nome != null) {
