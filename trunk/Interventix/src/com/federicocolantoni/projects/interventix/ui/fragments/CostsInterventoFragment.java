...
public class CostsInterventoFragment extends Fragment {
	...
	void showDialogManodopera() {
		...
		mEditManodopera.setText(""
				+ (InterventoController.controller.getIntervento().costomanodopera != null ? InterventoController.controller.getIntervento().costomanodopera : 0.0));
		...
		costoAccessoriDialog.setPositiveButton(R.string.ok_btn, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				InterventoController.controller.getIntervento().importo = (new BigDecimal(InterventoController.controller.getIntervento().costomanodopera.doubleValue()
						+ (InterventoController.controller.getIntervento().costoaccessori != null ? InterventoController.controller.getIntervento().costoaccessori.doubleValue()
								: 0.0)
						+ (InterventoController.controller.getIntervento().costocomponenti != null ? InterventoController.controller.getIntervento().costocomponenti.doubleValue()
								: 0.0)));
				...
				InterventoController.controller.getIntervento().totale = (new BigDecimal(InterventoController.controller.getIntervento().importo.doubleValue()
						+ InterventoController.controller.getIntervento().iva.doubleValue()));
	...
	void showDialogComponenti() {
		...
		mEditComponenti.setText(""
				+ (InterventoController.controller.getIntervento().costocomponenti != null ? InterventoController.controller.getIntervento().costocomponenti : 0.0));
		...
		costoAccessoriDialog.setPositiveButton(R.string.ok_btn, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				InterventoController.controller.getIntervento().importo = (new BigDecimal(InterventoController.controller.getIntervento().costocomponenti.doubleValue()
						+ (InterventoController.controller.getIntervento().costoaccessori != null ? InterventoController.controller.getIntervento().costoaccessori.doubleValue()
								: 0.0)
						+ (InterventoController.controller.getIntervento().costomanodopera != null ? InterventoController.controller.getIntervento().costomanodopera.doubleValue()
								: 0.0)));
				InterventoController.controller.getIntervento().iva = (new BigDecimal(InterventoController.controller.getIntervento().importo.doubleValue() * Constants.IVA));
				InterventoController.controller.getIntervento().totale = (new BigDecimal(InterventoController.controller.getIntervento().importo.doubleValue()
						+ InterventoController.controller.getIntervento().iva.doubleValue()));
	...
	void showDialogAccessori() {
		...
		mEditAccessori
				.setText("" + (InterventoController.controller.getIntervento().costoaccessori != null ? InterventoController.controller.getIntervento().costoaccessori : 0.0));
		...
		costoAccessoriDialog.setPositiveButton(R.string.ok_btn, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				InterventoController.controller.getIntervento().importo = (new BigDecimal(InterventoController.controller.getIntervento().costoaccessori.doubleValue()
						+ (InterventoController.controller.getIntervento().costomanodopera != null ? InterventoController.controller.getIntervento().costomanodopera.doubleValue()
								: 0.0)
						+ (InterventoController.controller.getIntervento().costocomponenti != null ? InterventoController.controller.getIntervento().costocomponenti.doubleValue()
								: 0.0)));
