...
@SuppressLint("NewApi")
@EFragment(R.layout.informations_fragment)
public class InformationsInterventoFragment extends Fragment {
	...
	if (!InterventoController.controller.getIntervento().nuovo)
	    ((ActionBarActivity) getActivity()).getSupportActionBar().setSubtitle(getString(R.string.numero_intervento) + InterventoController.controller.getIntervento().numero + " - " + getString(R.string.row_informations));
	else
